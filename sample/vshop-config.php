...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'vshop' ),
	'page_title'                => esc_html__( 'Theme Options', 'vshop' ),
...
$section = array(
	'title' => __( 'Basic Fields', 'vshop' ),
	'id'    => 'basic',
	'desc'  => __( 'Basic fields as subsections.', 'vshop' ),
	'icon'  => 'el el-home',
);
...
$section = array(
	'title'      => esc_html__( 'Text', 'vshop' ),
	'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'vshop' ) . '<a href="https://devs.redux.io/core-fields/text.html" target="_blank">https://devs.redux.io/core-fields/text.html</a>',
	...
	'fields'     => array(
		array(
			'id'       => 'text-example',
			'type'     => 'text',
			'title'    => esc_html__( 'Text Field', 'vshop' ),
			'subtitle' => esc_html__( 'Subtitle', 'vshop' ),
			'desc'     => esc_html__( 'Field Description', 'vshop' ),
...
$section = array(
	'title'      => esc_html__( 'Text Area', 'vshop' ),
	'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'vshop' ) . '<a href="https://devs.redux.io/core-fields/textarea.html" target="_blank">https://devs.redux.io/core-fields/textarea.html</a>',
	...
	'fields'     => array(
		array(
			'id'       => 'textarea-example',
			'type'     => 'textarea',
			'title'    => esc_html__( 'Text Area Field', 'vshop' ),
			'subtitle' => esc_html__( 'Subtitle', 'vshop' ),
			'desc'     => esc_html__( 'Field Description', 'vshop' ),
			'default'  => 'Default Text',
		),
